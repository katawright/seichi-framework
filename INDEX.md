...
| `guides/framework.md`                 | Cross-cutting concepts, roles, governance, and compliance guidance.       | governance, roles, design-principles, compliance, greenfield, brownfield, working-locations, mid-stage-discovery | stages, ai-assistance, right-sizing                          | core |
