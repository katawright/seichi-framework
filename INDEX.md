...
**Last Updated:** 2026-07-07 | **Framework Version:** 0.57.0
...
| `guides/operating-model.md`           | Layer-B operating model: who runs the process and how autonomously — operating functions, capability coverage, the envelope, Lights-Out, and the executor read path that scales implementation scaffolding. | operating-model, autonomy, lights-out, capability-coverage, operating-envelope, configurable-functions, executor-read-path, specification-depth | right-sizing, spec, checkpoints, brownfield-readiness                                        | core |
...
| `guides/right-sizing.md`              | Scales framework practices to project consequence, compliance, and stakeholder reach.                                                                                                                       | tiers, scaling, consequence, compliance, stakeholder-reach, process-weight, tier-selection                                                      | framework                                                                                    | core |
...
| `spec/canonical-state.md` | Canonical project-state contracts: minimum state, state versioning and write admission, artifacts-as-views, Markdown self-sufficiency, operating modes (file/platform), mode binding and switching, records, recording grades, evidence-independence and attribution-source grades, authorized-party roster, carry-forward conditions, folding. | canonical-state, artifacts-as-views, self-sufficiency, operating-modes, file-mode, platform-mode, mode-binding, mode-switching, state-version, write-admission, records, recording-grades, evidence-independence, attribution-source, authorized-party, carry-forward-conditions, folding | delegated-run, operating-model                  | ref  |
| `spec/delegated-run.md`   | Delegated-run contracts: lifecycle, liveness, durable state, idempotency, cross-run write model, replanning, completion.                                                                                                                                                                                                                        | delegated-run, lights-out, lifecycle, liveness, idempotency, write-admission, state-version, completion, replanning                                                                                                                                                                       | operating-model, canonical-state                | core |
...
| `templates/gate-decision.md`                   | Investment gate decision with criteria, evidence, and outcome.                                                                                     | gate, decision, investment, criteria, proceed-conditions-revise-stop                          | Initiation–System Design   | ref  |
