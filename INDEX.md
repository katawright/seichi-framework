...
**Last Updated:** 2026-06-20 | **Framework Version:** 0.48.0
...
1. Scan the [**Root Files**](#root-files-2), [**Guides**](#guides-22), or
   [**Spec**](#spec-4) tables to find cross-cutting content
2. Jump to the relevant [**Stage Artifacts**](#stage-artifacts-29) subsection
   for stage-specific files
3. Check [**Templates**](#templates-22) for fillable artifacts
...
| `guides/agentic-workflow.md`          | Stage routing table, agent orchestration, and fallback protocols.                                                                        | stage-routing, agent-orchestration, fallback, gate-enforcement, autonomy, working-locations, zero-to-one, classification-inference | all stages                                                                                   | core |     | `guides/brownfield.md` | Brownfield preparation process overview and routing to sub-guides. | brownfield, preparation, assessment, approach, enablement | brownfield-readiness, brownfield-approach, brownfield-enablement | ref |
...
| `stages/support/project-closeout-checklist.md` | Wrap-up gate: confirm learnings routed, outcomes reconciled, and the close-out summary produced. | close-out, wrap-up, retrospective, success-criteria, learnings         | support             | ref  |
...
| `templates/project-closeout.md`                | Readable close-out synthesis: why, outcomes, learnings, and next steps for a completed project. | close-out, project-closing, summary, outcomes, learnings                             | Support                    | ref  |
