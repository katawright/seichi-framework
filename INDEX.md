...
| `spec/canonical-state.md` | Canonical project-state contracts: minimum state, artifacts-as-views, Markdown self-sufficiency, operating modes (file/platform) and mode binding, records, recording grades, evidence-independence grade, authorized-party roster, carry-forward conditions, folding. | canonical-state, artifacts-as-views, self-sufficiency, operating-modes, file-mode, platform-mode, mode-binding, records, recording-grades, evidence-independence, authorized-party, carry-forward-conditions, folding | delegated-run, operating-model                  | ref  |
...
| `spec/operating-model.md` | Operating-model contracts: functions, coverage, envelope, floors, Lights-Out eligibility, separation, stop enforcement.                                                                                                                                                | operating-model, coverage, envelope, floors, lights-out, separation, stop-enforcement, executor-read-path                                                                                                             | operating-model (guide), delegated-run          | core |
