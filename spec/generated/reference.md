...
<!-- source_hash: sha256:0ed0c60f6d4a82d3a9da32ebe4b1a85320afd8cad0304aec8582e5d761b2f592 -->
...
- Edges: `proposed -> approved`, `proposed -> declined`, `declined -> proposed`, `proposed -> canceled`, `declined -> canceled`, `approved -> canceled`, `approved -> active`, `active -> paused`, `paused -> active`, `active -> completion-claimed`, `paused -> completion-claimed`, `completion-claimed -> completion-verified`, `completion-claimed -> failed`, `completion-claimed -> canceled`, `active -> failed`, `active -> canceled`, `active -> abandoned`, `active -> authorization-exhausted`, `paused -> failed`, `paused -> canceled`, `paused -> abandoned`, `paused -> authorization-exhausted`
- Reason sets (present iff the state requires one):
