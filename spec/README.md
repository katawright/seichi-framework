...
- State the operating-model, right-sizing, checkpoint, executor-conduct,
  delegated-run, parallel-batch, and canonical-state rules as executable
  contracts an agent can follow from the Markdown alone
