...
This file provides context to AI coding assistants (Claude, GitHub Copilot,
Cursor, etc.) about this project's structure, conventions, and workflow. It
...
- Constants: [e.g., UPPER_SNAKE_CASE in Python/Java, camelCase or
  UPPER_SNAKE_CASE in JavaScript]
...
- Example breakdown:
  ...
  3. API endpoints
  4. Frontend components _(if applicable)_
...
- Tests (coverage and meaningfulness)
...
[setup database - e.g., docker-compose up -d postgres]
[run migrations - e.g., python manage.py migrate]
[start server - e.g., python manage.py runserver]
```
...
- **Development/Staging:** [URL if applicable] - Deployed from: [branch, e.g.,
  `develop`]
- **Production:** [URL if applicable] - Deployed from: [branch, e.g., `main`]
...
def calculate_total(items: List[Item], discount: Optional[Decimal] = None) -> Decimal:
    ...
    Args:
        ...
        discount: Optional discount as decimal (e.g., 0.1 for 10% off)

    Returns:
        Total price as Decimal

    Raises:
        ValueError: If items is empty or discount is invalid

    Example:
        >>> calculate_total([Item(10), Item(20)], Decimal('0.1'))
        Decimal('27.00')
    """
```
...
**Metrics system:** [e.g., Prometheus, Datadog, CloudWatch] _(if applicable)_
...
- Architecture decisions: [e.g., RFC process, design review meetings]

**Escalation:** [e.g., Ping @tech-lead in Slack for blocking issues]
...
_This file follows the AI-Assisted SDLC framework. See
https://github.com/[your-org]/ai-assisted-sdlc for more information._
