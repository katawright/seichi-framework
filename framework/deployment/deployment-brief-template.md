...
**Increment:** [Increment name/ID]
**Deployment Date:** YYYY-MM-DD
**Deployment Engineer:** [Name]
**Status:** [Planning / Ready / In Progress / Completed / Rolled Back]
...
### Deployment Strategy
**Selected Strategy:** [Blue/Green / Canary / Rolling / Feature Flag / Big
Bang]
...
- [Specify timing between phases, e.g., "Monitor each canary phase for
  30 minutes"]
...
**Rollback Point:** [Can rollback from this phase? Yes/No]
**Quality Gate:** [What must pass to proceed to next phase?]
...
**Data Changes:** [Yes / No]
**Migration Type:** [Additive / Backward-Compatible / Breaking]
...
### Secrets Management
- [ ] New secrets added to secret manager (e.g., AWS Secrets Manager,
      HashiCorp Vault)
...
**Decision Maker:** [Name, Role] - Authority to initiate rollback
...
**Duration:** [X minutes]
**Use When:** [Rolling deployment or no blue/green available]
...
**Success Criterion 1:** [From Initiation, e.g., "Increase conversion rate
from 45% to 55%"]
...
**Resolution Plan:** [Fix in next release / Hotfix scheduled / Accepted
limitation]
...
### Issues Encountered
**Issue:** [Description of any issues during deployment]
**Resolution:** [How issue was resolved]
**Impact:** [Effect on deployment timeline or production]
...
**User Documentation:** [Link - if user-facing features]
