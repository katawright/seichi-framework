...
### Deployment Planning
- [ ] Deployment strategy selected and documented (blue/green, canary,
...
- [ ] Production environment health verified (infrastructure, database,
      services running)
...
**🚦 Quality Gate:** All items checked → Proceed to deployment
**❌ Red Flags:** UAT not signed off, no rollback plan, monitoring not
configured
...
**🚦 Quality Gate:** All items checked → Package ready for deployment
**❌ Red Flags:** Version mismatch, untested migrations, checksum failure
...
**🚦 Quality Gate:** All deployment steps completed successfully
**❌ Red Flags:** Health checks failing, migration errors, traffic routing
issues
...
- [ ] Success criteria instrumentation working (metrics appearing in
      dashboards)
...
procedure
**✅ If Stable:** No rollback needed → Continue monitoring
...
**🚦 Quality Gate:** 24 hours stable → Deployment considered successful
**❌ Red Flags:** Increasing error rates, user reports of issues, metric
anomalies
...
**🚦 Quality Gate:** All stakeholders informed of deployment outcome
**❌ Red Flags:** Stakeholders unaware of deployment or rollback
...
**🚦 Quality Gate:** Documentation complete and accessible
**❌ Red Flags:** Deployment undocumented, Support team unprepared
...
- [ ] Production credentials stored in secure location (password manager,
      vault)
...
**🚦 Quality Gate:** Database healthy and data integrity verified
**❌ Red Flags:** Missing data, schema corruption, performance degradation
...
- [ ] Success criteria check-in schedule established (when to measure
      progress)
...
**❌ Red Flags:** Support unprepared, monitoring not configured, unclear
ownership
...
**❌ Red Flags:** Missing approvals, unclear next steps
