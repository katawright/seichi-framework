...
**Support Team:** [Team name or members]
**Status:** [Active / Maintenance Mode / End of Life]
...
**Current Version:** [v1.2.0 or release identifier]
**Deployed:** [Date of most recent production deployment]
**Production Environment:** [URL(s) and environment details]
...
| Response Time (p95) | <500ms | >1000ms for 15 min | >2000ms for 10 min |
| Throughput | 100 req/s | <80 req/s for 20 min | <50 req/s for 10 min |
...
| Memory Usage | <80% | >90% for 15 min | >95% for 5 min |
| Disk Usage | <70% | >85% | >95% |
...
|--------|----------|--------|---------|--------|
| [Metric 1] | [45%] | [55%] | [52%] | 🟢 On track |
| [Metric 2] | [3.5s] | [2.0s] | [2.8s] | 🟡 Improving |
| [Metric 3] | [$100K] | [$150K] | [$ 95K] | 🔴 Behind |
...
### On-Call Rotation
**Current On-Call:** [Name, Contact, Slack handle]
**Backup On-Call:** [Name, Contact, Slack handle]
**Rotation Schedule:** [Weekly, rotating Mondays, etc.]
...
**Communication:** Immediately notify all stakeholders, create incident channel
...
**Symptoms:** Error rate >5%, users reporting 500 errors
**Diagnosis:**
...
**Symptoms:** p95 response time >2000ms, users report slowness
**Diagnosis:**
...
**Issue 3: [Common Issue Name]**
**Symptoms:** [What users see or alerts show]
**Diagnosis:** [How to identify root cause]
**Common Causes:** [Typical reasons this occurs]
...
1. Create hotfix branch from production tag: `git checkout -b
   hotfix/issue-description v1.2.0`
...
7. Merge hotfix to main: `git checkout main && git merge
   hotfix/issue-description`

**Runbook 2: Rollback Deployment**
1. Identify previous stable version (check deployment history)
2. Execute rollback: `kubectl rollout undo deployment/myapp` or `./deploy.sh
   v1.1.0`
...
4. Apply changes: `terraform apply` or `kubectl scale deployment/myapp
   --replicas=X`
...
**Bug Labels/Tags:** [bug, production, hotfix, critical, etc.]
**Bug Workflow:** [New → Triaged → In Progress → Fixed → Verified → Closed]
...
### Enhancement Backlog
**Backlog Location:** [Product roadmap tool, Jira, etc.]
**Enhancement Sources:**
...
**Success Criterion 1:** [Description, e.g., "Increase checkout conversion
from 45% to 55%"]
...
**Success Criterion 2:** [Description, e.g., "Reduce page load time from 3.5s
to 2.0s"]
...
**Documentation:** [Link to user guides, FAQs, knowledge base]
**Training:** [Link to training materials, videos, onboarding]
...
**Issue 1: [Common user question]**
**Resolution:** [How to resolve]
**Documentation:** [Link to relevant docs]

**Issue 2: [Common user question]**
**Resolution:** [How to resolve]
**Documentation:** [Link to relevant docs]
...
| Dependency | Current Version | Latest Version | Security Issues | Action |
|------------|----------------|----------------|-----------------|--------|
| [Library 1] | 2.3.0 | 2.5.1 | None | Update in next sprint |
| [Library 2] | 1.8.2 | 1.8.5 | CVE-2024-1234 | Hotfix immediately |
...
### Recent Changes
**Last Deployment:** [Date, version, what changed]
**Recent Incidents:** [Date, severity, resolution, follow-up actions]
**Ongoing Issues:** [Open bugs, known limitations, items being monitored]
...
**Support Brief Status:** [Active / Needs Update / Under Review]
**Next Review Date:** [YYYY-MM-DD - recommend quarterly reviews]
