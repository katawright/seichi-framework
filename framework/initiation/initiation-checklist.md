...
**Purpose:** Quick validation (60-90 seconds) that the Initiation Brief is ready
to circulate.

**Usage:** Review before sharing the brief with stakeholders for Gate 1.
...
3. **Goals include at least one measurable success metric** (baseline -> target
   where possible)
...
> **If items 1-4 and 10-12 are missing, the brief is usually not ready to
> circulate.**
