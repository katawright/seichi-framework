...
<!-- For examples, see ../system-design/system-design-reference.md#design-brief-examples -->
...
<!-- For examples, see ../system-design/system-design-reference.md#increment-plan-example -->

### Gate 2 Decision Package

<!-- Record the decision using templates/gate-decision-template.md -->
