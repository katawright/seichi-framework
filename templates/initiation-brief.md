...
<!-- See ../guides/operating-model.md for the operating model behind these fields.
     When the agent infers these (zero-to-one or first-time users), they carry
